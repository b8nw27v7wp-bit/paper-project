...
export type RouteMetaExtra = { public?: boolean; title?: string; group?: 'core' | 'know' | 'analyse' | 'system'; keepAlive?: boolean; prefetch?: boolean }
const routes = [
  { path: '/', name: 'Home', component: () => import('@/views/HomeView.vue'), meta: { title: '首页', group: 'core', keepAlive: true } as RouteMetaExtra },
  ...
  { path: '/dashboard', name: 'Dashboard', component: () => import('@/views/DashboardView.vue'), meta: { title: '大屏', group: 'analyse' } as RouteMetaExtra },
  ...
  { path: '/large-screen', name: 'LargeScreen', component: () => import('@/views/LargeScreenView.vue'), meta: { title: '驾驶舱', group: 'analyse' } as RouteMetaExtra },
  ...
  { path: '/workbench', name: 'Workbench', component: () => import('@/views/WorkbenchView.vue'), meta: { title: '工作台', group: 'core', keepAlive: true } as RouteMetaExtra },
